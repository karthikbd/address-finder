"""
Quantize address-finder's raw float64 weight arrays to int8 + per-row scale.
...
# ─── File format ──────────────────────────────────────────────────────────
# Original binary layout (averaged_perceptron.c):
...
def quantize_perceptron(src_path: pathlib.Path, dst_path: pathlib.Path):
    """Convert a raw perceptron .bin file to quantized int8."""
